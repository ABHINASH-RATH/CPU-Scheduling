 ...
 * END TERM PROJECT 
 * CPU SCHEDULING
 * Subject : -DESIGN OF OPERATING SYSTEMS (CSE 4049)
 * DATE - 19/01/2022
...
int main()
{
	...
	printf("\t\t|    Choose One Method Of CPU scheduling            |\n" );
	printf("\t\t|       1.First Come First Served (F.C.F.S)         |\n");
	printf("\t\t|       2.Shortest Job First (S.J.F)                |\n"); 
	printf("\t\t|       3.Shortest Remaining Time First (S.R.T.F)   |\n");
	printf("\t\t|       4.Round Robin Scheduling (R.R)              |\n");
